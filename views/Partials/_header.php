...
<link href="img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <header>
        ...
        <div class="row">
            <div class="col-11">
            <span class="text"><strong><a class="parpadea text-uppercase" href="https://p-campus.fundacionprocem.org/" style="color: #fcfcfc;font-size: 18px;" > Conoce Procem P-Campus </a></strong>
            </div>
            <div class="col-1">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light sombra">
                        <a class="navbar-brand" href="#"><img class="icop" src="img/procem/logo.png" alt=""></a>
